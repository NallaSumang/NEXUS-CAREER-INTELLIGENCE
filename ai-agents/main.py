...
from agents import resume_agent, job_parser_agent, match_agent, cover_letter_agent, interview_coach_agent, analytics_agent
...
app.include_router(interview_coach_agent.router, prefix="/agents", tags=["Interview Coach"])
