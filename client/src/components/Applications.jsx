...
export default function Applications() {
  ...
  const handleDownloadGapAnalysis = () => {
    if (!activeApplication || activeApplication.matchScore === undefined)
      return;
        ...
        {activeApplication && activeApplication.matchScore !== undefined && (
          <div className="mb-16 border border-[#D4AF37] p-8 glass-panel-hover">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-[#D4AF37] text-[10px] tracking-widest uppercase">
                Alignment Score
              </h3>
              <button
            ...
            <div className="flex items-end gap-4 mb-8">
              <span className="text-6xl font-serif text-[#D4AF37]">
                {activeApplication.matchScore || "0"}%
              </span>
              <span className="text-[10px] tracking-widest text-[#888888] uppercase mb-2">
                PROBABILITY
              </span>
            </div>
            {activeApplication.missingSkills &&
              activeApplication.missingSkills.length > 0 && (
                <div className="mb-8">
                  <p className="text-[10px] tracking-widest uppercase text-red-500 mb-2">
                    VULNERABILITIES (MISSING SKILLS)
                  </p>
          ...
          applications.map((app) => (
            ...
            >
              ...
              <div className="flex justify-between items-center text-[10px] tracking-widest uppercase">
                <span
                  className={
                    app.matchScore ? "text-[#D4AF37]" : "text-[#555555]"
                  }
                >
