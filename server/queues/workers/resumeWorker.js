...
const resumeWorker = new Worker('resume-processing', async (job) => {
  ...
  try {
    ...
    console.log(`[Worker] Text extracted. Forwarding to Python AI Microservice...`);
    const res = await axios.post(`${aiServiceUrl}/agents/parse-resume`, {
      text: rawText,
